...
export const ELEMENTARY_TOPICS = [
  ...
  },
  {
    ...
    "track": null,
    "cluster": "שברים",
    "title": "חיבור וחיסור שברים ומספרים מעורבים",
    "description": "שלושה מקרים: מכנה אחד כפולת השני, מכנים עם גורם משותף, ומכנים זרים",
    "sortOrder": 8,
    "explanation": "<span class='hl-teal'>תזכורת</span>: כשלשני השברים אותו מכנה, פשוט מחברים (או מחסרים) את המונים ומשאירים את המכנה: $\\frac{3}{8}+\\frac{6}{8}=\\frac{9}{8}$.\n\nכשהמכנים שונים, תמיד צריך קודם להביא אותם ל<span class='hl-coral'>מכנה משותף</span>. יש שלושה סוגי מקרים, מהקל לקשה:\n\n<span class='hl-teal'>1. מכנה אחד הוא כפולה של השני</span> — למשל $\\frac{1}{2}+\\frac{1}{4}$: מכיוון ש-$4$ הוא כפולה של $2$, מרחיבים רק את $\\frac{1}{2}$: $\\frac{1}{2}=\\frac{2}{4}$, ואז $\\frac{2}{4}+\\frac{1}{4}=\\frac{3}{4}$.\n\n<span class='hl-teal'>2. למכנים יש גורם משותף</span> (אך אחד אינו כפולה של השני) — למשל $\\frac{1}{4}+\\frac{1}{6}$: המכנה המשותף הוא $12$ (לא צריך להכפיל $4\\times6=24$, כי $12$ קטן יותר ומספיק): $\\frac{3}{12}+\\frac{2}{12}=\\frac{5}{12}$.\n\n<span class='hl-teal'>3. המכנים זרים</span> (אין להם גורם משותף מלבד $1$) — למשל $\\frac{1}{3}+\\frac{1}{5}$: המכנה המשותף היחיד הקטן הוא המכפלה $3\\times5=15$: $\\frac{5}{15}+\\frac{3}{15}=\\frac{8}{15}$.\n\n<span class='hl-teal'>מספרים מעורבים</span> — מחברים או מחסרים בנפרד את השלמים ואת השברים, ואם צריך \"שואלים\" שלם מהחלק השלם כדי לחסר שבר גדול יותר.\n\n<span class='hl-coral'>תכונות $0$ ו-$1$, חוק החילוף וחוק הקיבוץ</span> מתקיימים גם בשברים, בדיוק כמו במספרים טבעיים.\n\n<span class='hl-teal'>אומדן</span> — לפני חישוב מדויק, אפשר לאמוד את הסכום/ההפרש על ידי עיגול כל שבר למספר השלם הקרוב אליו.",
    "keyFormulas": [
      "מכנה אחד כפולת השני: מרחיבים רק את השבר עם המכנה הקטן",
      "גורם משותף: המכנה המשותף קטן ממכפלת המכנים",
      "מכנים זרים: המכנה המשותף הוא מכפלת שני המכנים",
  ...
  },
  {
    ...
    "description": "כפל שלם בשבר כחיבור חוזר",
    "sortOrder": 9,
    "explanation": "כפל מספר שלם בשבר הוא <span class='hl-teal'>חיבור חוזר</span> של אותו שבר, בדיוק כמו שכפל בשלמים הוא חיבור חוזר: $4\\times\\frac{2}{5}=\\frac{2}{5}+\\frac{2}{5}+\\frac{2}{5}+\\frac{2}{5}=\\frac{8}{5}$.\n\n<span class='hl-teal'>קיצור החישוב</span> — במקום לחבר שוב ושוב, כופלים ישירות את השלם במונה ומשאירים את המכנה: $4\\times\\frac{2}{5}=\\frac{4\\times2}{5}=\\frac{8}{5}$.\n\n<span class='hl-teal'>כפל שלם במספר מעורב</span> עובד באותו עיקרון: $3\\times2\\frac{1}{4}$ פירושו $2\\frac{1}{4}+2\\frac{1}{4}+2\\frac{1}{4}$. נוח להפוך קודם את המספר המעורב לשבר מדומה: $2\\frac{1}{4}=\\frac{9}{4}$, ואז $3\\times\\frac{9}{4}=\\frac{27}{4}=6\\frac{3}{4}$.\n\n<span class='hl-coral'>שימו לב</span> — התוצאה של כפל שלם בשבר יכולה להיות קטנה מהשלם המקורי (אם השבר קטן מ-$1$) או גדולה ממנו (אם השבר גדול מ-$1$).",
    "keyFormulas": [
      "$k\\times\\frac{a}{b}=\\frac{k\\times a}{b}$ (כחיבור חוזר של $k$ פעמים)",
      "מספר מעורב: הופכים לשבר מדומה לפני הכפל",
      "$3\\times2\\frac{1}{4}=3\\times\\frac{9}{4}=\\frac{27}{4}=6\\frac{3}{4}$"
    ]
  },
  {
    "id": "g5-decimals-ops",
  ...
  },
  {
    ...
    "cluster": "גאומטריה ומדידות",
    "title": "שטח, היקף ונפח",
    "description": "חזרה והעשרה: נוסחאות שטח/היקף, נפח תיבה ושטח פנים (מיסודות כיתה ד')",
    "sortOrder": 19,
  ...
  },
  {
    ...
    "description": "טבלת שכיחויות, שכיח, וקריאת נתונים מטבלאות, דיאגרמות ופיקטוגרמות",
    "sortOrder": 17,
    "explanation": "כשאוספים הרבה מידע, אפשר לארגן אותו ב<span class='hl-teal'>טבלת שכיחויות</span> — טבלה שמראה כמה פעמים כל ערך מופיע בנתונים.\n\n<span class='hl-teal'>שכיחות</span> של ערך מסוים היא מספר הפעמים שהוא מופיע. ה<span class='hl-teal'>שכיח</span> הוא הערך בעל השכיחות הגבוהה ביותר — זה שמופיע הכי הרבה פעמים.\n\n<div class='diagram-box'><svg viewBox='0 0 260 110' xmlns='http://www.w3.org/2000/svg'><line x1='20' y1='90' x2='120' y2='90' stroke='#1a2b3c' stroke-width='2'/><line x1='20' y1='90' x2='20' y2='10' stroke='#1a2b3c' stroke-width='2'/><rect x='35' y='55' width='22' height='35' fill='#0d6e6e' opacity='0.6'/><rect x='65' y='30' width='22' height='60' fill='#0d6e6e' opacity='0.6'/><rect x='95' y='65' width='22' height='25' fill='#0d6e6e' opacity='0.6'/><circle cx='195' cy='50' r='40' fill='none' stroke='#0d6e6e' stroke-width='2'/><path d='M195,50 L195,10 A40,40 0 0 1 230,70 Z' fill='#c45c48' opacity='0.4'/></svg></div>\n\n<span class='hl-teal'>אותם נתונים אפשר להציג בכמה דרכים</span>: טבלה, דיאגרמת עמודות, דיאגרמת עוגה, או פיקטוגרם (סמלים חוזרים שכל אחד מייצג כמות קבועה). לכל דרך יש יתרון שונה — טבלה מדויקת, עמודות מראות השוואה בקלות, ועוגה מראה חלוקה יחסית של השלם.\n\n<span class='hl-coral'>קריאת פיקטוגרם</span> — סופרים את הסמלים (כולל חצאי סמלים) ומכפילים בערך שכל סמל מייצג.",
    "keyFormulas": [
      "שכיחות $=$ מספר הפעמים שערך מופיע בנתונים",
      "שכיח $=$ הערך בעל השכיחות הגבוהה ביותר",
      "אותם נתונים ניתנים להצגה בטבלה, עמודות, עוגה או פיקטוגרם",
      "בפיקטוגרם: סופרים סמלים ומכפילים בערך שכל סמל מייצג"
    ]
  },
  {
    ...
    "description": "חישוב ממוצע וחציון של קבוצת נתונים (העשרה מעבר לתוכנית הרשמית)",
    "sortOrder": 18,
    "explanation": "<span class='hl-teal'>ממוצע</span> הוא דרך לתאר \"ערך טיפוסי\" של קבוצת נתונים. מחשבים אותו כך:\n1. מחברים את **כל** הערכים יחד.\n2. מחלקים את הסכום ב**מספר** הערכים.\n\nלמשל, ממוצע הציונים $80,90,70$ הוא $\\dfrac{80+90+70}{3}=\\dfrac{240}{3}=80$.\n\n<span class='hl-teal'>חציון</span> הוא הערך <span class='hl-teal'>האמצעי בדיוק</span> ברשימה ממוינת מהקטן לגדול. לדוגמה, בחציון של $6,8,12,14,19$ — המספרים כבר ממוינים, והערך האמצעי הוא $12$.\n\n<span class='hl-success'>שימו לב</span>: הממוצע תמיד נמצא בין הערך הקטן ביותר לגדול ביותר, אבל הוא לא חייב להיות אחד המספרים המקוריים.\n\n<span class='hl-coral'>הערה</span>: נושא זה הוא העשרה מעבר לתוכנית הלימודים הרשמית של כיתה ה', אך שימושי להיכרות מוקדמת עם חקר נתונים.",
    "keyFormulas": [
  ...
  },
  {
    ...
    "keyFormulas": [
      ...
      "לכל מספר טבעי יש עוקב; יש אין-סוף מספרים טבעיים; מיליארד $=1{,}000$ מיליון"
    ]
  },
  {
    "id": "g5-primes",
  ...
  },
  {
    ...
    "description": "מודל עוגה, מודל מלבני, רצועות שברים, וייצוג שברים גדולים מ-1 על ישר המספרים",
    "sortOrder": 4,
    "explanation": "אפשר לייצג את אותו שבר בכמה <span class='hl-teal'>מודלים חזותיים</span> שונים: <span class='hl-teal'>מודל \"עוגה\"</span> (עיגול מחולק לחלקים), <span class='hl-teal'>מודל מלבני</span> (מלבן או ריבוע מחולק לחלקים שווים), ו<span class='hl-teal'>רצועת שברים</span> (קטע מחולק לחלקים שווים).\n\n<div class='diagram-box'><svg viewBox='0 0 260 90' xmlns='http://www.w3.org/2000/svg'><circle cx='50' cy='45' r='35' fill='none' stroke='#0d6e6e' stroke-width='2'/><path d='M50,45 L50,10 A35,35 0 0 1 85,45 Z' fill='#0d6e6e' opacity='0.3'/><rect x='120' y='20' width='120' height='30' fill='none' stroke='#0d6e6e' stroke-width='2'/><line x1='150' y1='20' x2='150' y2='50' stroke='#0d6e6e'/><line x1='180' y1='20' x2='180' y2='50' stroke='#0d6e6e'/><line x1='210' y1='20' x2='210' y2='50' stroke='#0d6e6e'/><rect x='120' y='20' width='30' height='30' fill='#0d6e6e' opacity='0.3'/><text x='50' y='85' text-anchor='middle' font-size='11' fill='#1a2b3c'>מודל עוגה</text><text x='180' y='65' text-anchor='middle' font-size='11' fill='#1a2b3c'>מודל מלבני</text></svg></div>\n\nבכיתה ה' מרחיבים את הייצוג של שבר <span class='hl-teal'>כנקודה על ישר המספרים</span> גם ל<span class='hl-coral'>שברים גדולים מ-$1$</span>, ולא רק לשברים בין $0$ ל-$1$. למשל, $\\frac{7}{4}$ ממוקם בין $1$ ל-$2$ (כי $\\frac{7}{4}=1\\frac{3}{4}$), קרוב ל-$2$.\n\n<span class='hl-teal'>שימוש בישר מספרים</span> עוזר לפתור בעיות כמו: איזה שבר יכול להתאים לקטע מסוים, או מציאת שברים חסרים בין שני שברים נתונים על הישר.",
    "keyFormulas": [
      "אותו שבר אפשר לייצג במודל עוגה, מודל מלבני, או רצועת שברים",
      "שברים גדולים מ-$1$ גם הם ממוקמים על ישר המספרים",
      "$\\frac{7}{4}=1\\frac{3}{4}$ נמצא בין $1$ ל-$2$"
    ]
  },
  {
  ...
  },
  {
    ...
    "track": null,
    "cluster": "שברים",
    "title": "השוואה בין שברים בדרכים שונות",
    "description": "השוואה על ידי מכנה משותף, השוואה לחצי/לשלם, השלמה לשלם, ומונים שווים",
    "sortOrder": 6,
    "explanation": "יש כמה דרכים להשוות בין שני שברים, ואפשר לבחור את הדרך הכי נוחה לכל מקרה:\n\n<span class='hl-teal'>1. מכנה משותף</span> — מרחיבים את שני השברים למכנה משותף, ואז משווים רק את המונים: $\\frac{2}{3}$ מול $\\frac{3}{5}$ — מכנה משותף $15$: $\\frac{10}{15}$ מול $\\frac{9}{15}$, אז $\\frac{2}{3}>\\frac{3}{5}$.\n\n<span class='hl-teal'>2. השוואה לחצי</span> — בודקים אם כל שבר גדול או קטן מ-$\\frac{1}{2}$. $\\frac{3}{5}>\\frac{1}{2}$ אבל $\\frac{2}{5}<\\frac{1}{2}$, אז $\\frac{3}{5}>\\frac{2}{5}$.\n\n<span class='hl-teal'>3. השלמה לשלם</span> — בודקים כמה חסר לכל שבר כדי להגיע ל-$1$ שלם. פחות חסר = שבר גדול יותר. ל-$\\frac{7}{8}$ חסר $\\frac{1}{8}$, ול-$\\frac{5}{6}$ חסר $\\frac{1}{6}$ — מכיוון ש-$\\frac{1}{8}<\\frac{1}{6}$, <span class='hl-coral'>$\\frac{7}{8}>\\frac{5}{6}$</span>.\n\n<span class='hl-teal'>4. השוואה במונים שווים</span> — כשלשני השברים אותו מונה, השבר עם המכנה הקטן יותר גדול יותר: $\\frac{3}{7}>\\frac{3}{10}$.",
    "keyFormulas": [
      "מכנה משותף: מרחיבים ומשווים מונים",
      "השוואה לחצי: בודקים אם כל שבר $>$ או $<\\frac{1}{2}$",
      "השלמה לשלם: פחות חסר = שבר גדול יותר",
      "מונים שווים: מכנה קטן יותר ⟸ שבר גדול יותר"
    ]
  },
  {
  ...
  },
  {
    ...
    "cluster": "גאומטריה ומדידות",
    "title": "גובה של משולש",
    "description": "זיהוי, סרטוט וסיווג משולשים לפי זוויות, וגובה בכל סוג משולש",
    "sortOrder": 12,
    "explanation": "ה<span class='hl-teal'>גובה</span> של משולש הוא הקטע המאונך (בזווית $90°$) מקודקוד אל הצלע שמולו (הנקראת \"בסיס\") — או אל <span class='hl-coral'>המשך</span> אותה צלע, אם צריך.\n\n<div class='diagram-box'><svg viewBox='0 0 300 110' xmlns='http://www.w3.org/2000/svg'><polygon points='20,95 90,95 55,20' fill='none' stroke='#0d6e6e' stroke-width='2.5'/><line x1='55' y1='95' x2='55' y2='20' stroke='#c45c48' stroke-width='2' stroke-dasharray='4'/><text x='55' y='108' text-anchor='middle' font-size='11'>חד-זוויות</text><polygon points='130,95 200,95 130,20' fill='none' stroke='#0d6e6e' stroke-width='2.5'/><rect x='130' y='83' width='12' height='12' fill='none' stroke='#0d6e6e'/><text x='165' y='108' text-anchor='middle' font-size='11'>ישר-זווית</text><polygon points='230,95 295,95 250,30' fill='none' stroke='#0d6e6e' stroke-width='2.5'/><line x1='250' y1='95' x2='250' y2='30' stroke='#c45c48' stroke-width='2' stroke-dasharray='4'/><text x='262' y='108' text-anchor='middle' font-size='11'>קהה-זווית</text></svg></div>\n\n<span class='hl-teal'>סיווג משולשים לפי זוויות:</span>\n- <span class='hl-teal'>חד-זוויות</span> — כל שלוש הזוויות קטנות מ-$90°$. הגובה מכל קודקוד נופל בתוך המשולש.\n- <span class='hl-teal'>ישר-זווית</span> — יש בו זווית אחת בדיוק של $90°$. שתיים מהצלעות (הניצבים) הן עצמן גבהים.\n- <span class='hl-teal'>קהה-זווית</span> — יש בו זווית אחת גדולה מ-$90°$. חלק מהגבהים נופלים <span class='hl-coral'>מחוץ</span> למשולש, על המשך הבסיס.\n\nלכל משולש יש <span class='hl-teal'>שלושה גבהים אפשריים</span> — אחד לכל צלע (כל צלע יכולה לשמש בסיס). כדי לסרטט גובה, מציבים את הזווית הישרה (בעזרת סרגל משולש) בין הקודקוד לבין הבסיס או המשכו.",
    "keyFormulas": [
      "גובה = קטע מאונך מקודקוד לצלע שמולו (הבסיס) או להמשכה",
      "חד-זוויות: גובה תמיד בתוך המשולש",
      "קהה-זווית: חלק מהגבהים נופלים מחוץ למשולש",
      "לכל משולש יש $3$ גבהים אפשריים"
    ]
  },
  {
    "id": "g5-triangle-area",
    ...
    "description": "נוסחת שטח משולש, בחירת בסיס וגובה מתאימים, והיקף משולש",
    "sortOrder": 13,
    "explanation": "<span class='hl-teal'>שטח משולש</span> — לוקחים **בסיס כלשהו וגובה ליד אותו בסיס**, כופלים אותם, ומחלקים ב-$2$ (כי המשולש הוא בדיוק חצי ממלבן שאורכיו הם הבסיס והגובה).\n\n<span class='hl-teal'>אפשר לבחור כל אחת מצלעות המשולש כבסיס</span> — כל עוד משתמשים בגובה המתאים לאותה צלע, מתקבלת אותה תוצאה בדיוק, בכל שלוש הדרכים.\n\n<span class='hl-coral'>חשוב</span> — הגובה חייב להיות <span class='hl-coral'>מאונך לבסיס שנבחר</span>, לא סתם צלע אחרת של המשולש.\n\n<span class='hl-teal'>היקף משולש</span> — פשוט מחברים את אורכי שלוש הצלעות.\n\n<span class='hl-teal'>פירוק והרכבה</span> — אפשר לפרק משולשים ולהרכיב אותם מחדש ליצירת מלבנים או מקביליות, כדי להבין את הקשר בין שטחי הצורות השונות.",
    "keyFormulas": [
      "שטח משולש $=\\dfrac{\\text{בסיס}\\times\\text{גובה}}{2}$",
      "אותה תוצאה מתקבלת מכל אחת משלוש הצלעות כבסיס (עם הגובה המתאים)",
  ...
  },
  {
    ...
    "description": "זיהוי וסרטוט גובה במקביליות במנחים שונים, ושני הגבהים האפשריים",
    "sortOrder": 14,
    "explanation": "במקבילית (מרובע עם שני זוגות צלעות מקבילות), ה<span class='hl-teal'>גובה</span> הוא המרחק המאונך בין שני הבסיסים המקבילים — <span class='hl-coral'>לא</span> אחת הצלעות המשופעות.\n\n<div class='diagram-box'><svg viewBox='0 0 200 110' xmlns='http://www.w3.org/2000/svg'><polygon points='50,90 170,90 140,20 20,20' fill='#0d6e6e' fill-opacity='0.12' stroke='#0d6e6e' stroke-width='2.5'/><line x1='60' y1='90' x2='60' y2='20' stroke='#c45c48' stroke-width='2' stroke-dasharray='4'/><text x='65' y='55' font-size='11' fill='#c45c48'>גובה</text></svg></div>\n\nלמקבילית יש <span class='hl-teal'>שני זוגות צלעות</span>, ולכן גם <span class='hl-teal'>שני גבהים אפשריים</span> — אחד לכל זוג צלעות (בסיסים). כל קטע המחבר קודקוד לצלע נגדית (או להמשכה) ומאונך לה, הוא גובה של המקבילית.\n\n<span class='hl-coral'>שימו לב</span> — כשמקבילית מוצגת ב\"שיפוע\" (לא עם צלע אופקית), עדיין אפשר ואפילו חשוב לזהות ולסרטט את הגובה נכון, ביחס לבסיס שבחרתם.",
    "keyFormulas": [
      "גובה מקבילית = מרחק מאונך בין שני הבסיסים המקבילים",
      "למקבילית יש $2$ גבהים אפשריים — אחד לכל זוג צלעות",
      "הגובה אינו אחת הצלעות המשופעות"
    ]
  },
  {
    ...
    "cluster": "גאומטריה ומדידות",
    "title": "שטח מקבילית",
    "description": "נוסחת שטח מקבילית, וחישוב בעזרת שני הגבהים",
    "sortOrder": 15,
    "explanation": "<span class='hl-teal'>שטח מקבילית $=$ בסיס $\\times$ גובה</span> — בדיוק כמו מלבן, רק שהגובה הוא המרחק המאונך, לא הצלע המשופעת עצמה.\n\n<span class='hl-teal'>קשר לשטח מלבן ולשטח משולש</span> — אם חותכים משולש מקצה המקבילית ומזיזים אותו לצד השני, מתקבל מלבן בעל אותו שטח בדיוק. גם שני משולשים חופפים יכולים להיצמד וליצור מקבילית, כך ששטח המשולש הוא <span class='hl-teal'>מחצית</span> משטח המקבילית שנוצרת ממנו.\n\n<span class='hl-coral'>שתי דרכים לחשב את אותו שטח</span> — מכיוון שלמקבילית יש $2$ גבהים, אפשר לחשב את השטח באמצעות כל אחד מהזוגות (בסיס $1$ עם הגובה שלו, או בסיס $2$ עם הגובה שלו) ולקבל את אותה תוצאה.",
    "keyFormulas": [
      "שטח מקבילית $=$ בסיס $\\times$ גובה",
      "שטח משולש $=$ מחצית משטח המקבילית התואמת לו",
      "שני החישובים (עם כל זוג בסיס-גובה) נותנים אותה תוצאה"
    ]
  },
  {
    "id": "g5-solids",
    ...
    "description": "תכונות ופריסות של פירמידות ומנסרות, ומושגי בסיס/פאה/מקצוע/קודקוד",
    "sortOrder": 16,
    "explanation": "גופים תלת-ממדיים מתוארים לפי שלושה חלקים:\n- <span class='hl-teal'>פאות</span> — המשטחים השטוחים החיצוניים.\n- <span class='hl-teal'>מקצועות</span> — הקווים שבהם נפגשות שתי פאות.\n- <span class='hl-teal'>קודקודים</span> — הנקודות שבהן נפגשים כמה מקצועות.\n\n<span class='hl-teal'>פירמידה ישרה</span> — יש לה <span class='hl-teal'>בסיס אחד</span> (יכול להיות כל צורה — משולש, ריבוע, מחומש וכו') ו<span class='hl-teal'>פאות צדדיות משולשות</span> שכולן נפגשות בנקודה אחת למעלה, הנקראת <span class='hl-teal'>פסגה</span>.\n\n<span class='hl-teal'>מנסרה ישרה</span> — יש לה <span class='hl-teal'>שני בסיסים זהים ומקבילים</span> (למעלה ולמטה), מחוברים ב<span class='hl-teal'>פאות צדדיות מלבניות</span>.\n\n<div class='diagram-box'><svg viewBox='0 0 260 110' xmlns='http://www.w3.org/2000/svg'><polygon points='50,90 90,90 70,75 30,75' fill='none' stroke='#0d6e6e' stroke-width='2'/><line x1='30' y1='75' x2='60' y2='15' stroke='#0d6e6e' stroke-width='2'/><line x1='90' y1='90' x2='60' y2='15' stroke='#0d6e6e' stroke-width='2'/><line x1='70' y1='75' x2='60' y2='15' stroke='#0d6e6e' stroke-width='2' stroke-dasharray='3'/><line x1='50' y1='90' x2='60' y2='15' stroke='#0d6e6e' stroke-width='2'/><text x='60' y='105' text-anchor='middle' font-size='11'>פירמידה</text><polygon points='160,90 220,90 235,75 175,75' fill='none' stroke='#c45c48' stroke-width='2'/><polygon points='175,75 235,75 235,25 175,25' fill='none' stroke='#c45c48' stroke-width='2'/><polygon points='160,90 175,75 175,25 160,40' fill='none' stroke='#c45c48' stroke-width='2' stroke-dasharray='3'/><text x='195' y='105' text-anchor='middle' font-size='11'>מנסרה</text></svg></div>\n\n<span class='hl-coral'>פריסה</span> היא צורה שטוחה שכשמקפלים אותה לפי הקווים, מתקבל הגוף. אפשר לבדוק אם פריסה מתאימה לגוף מסוים על ידי דמיון או קיפול בפועל — ולפעמים יש כמה פריסות תקינות לאותו גוף.",
    "keyFormulas": [
      "פירמידה: בסיס אחד + פאות משולשות שנפגשות בפסגה אחת",
      "מנסרה: שני בסיסים זהים ומקבילים + פאות צדדיות מלבניות",
      "מושגים: פאה, מקצוע, קודקוד",
      "פריסה תקינה מתקפלת בדיוק לגוף המבוקש, בלי חורים או חפיפות"
    ]
  },
  {
    "id": "g5-percent-intro",
    ...
    "description": "המשמעות של אחוז כחלק ממאה, הקשר בין אחוזים לשברים ולשברים עשרוניים, וחישוב אחוזים \"ידידותיים\" מכמות",
    "sortOrder": 20,
    "explanation": "<span class='hl-teal'>אחוז</span> הוא דרך נוספת לתאר שבר — כזה שהמכנה שלו הוא תמיד $100$. הסימן $\\%$ פירושו \"מתוך מאה\": $37\\%$ הוא בדיוק $\\frac{37}{100}$.\n\n<div class='diagram-box'><svg viewBox='0 0 240 40' xmlns='http://www.w3.org/2000/svg'><rect x='0' y='8' width='240' height='24' fill='none' stroke='#1a2b3c' stroke-width='1.5'/><rect x='0' y='8' width='120' height='24' fill='#0d6e6e' opacity='0.5'/><text x='60' y='25' text-anchor='middle' font-size='12' fill='#fff'>50%</text><text x='180' y='25' text-anchor='middle' font-size='12' fill='#1a2b3c'>50%</text></svg></div>\n\nמכיוון שאחוז הוא שבר עם מכנה $100$, אפשר תמיד לעבור בינו לבין <span class='hl-teal'>שבר פשוט</span> ו<span class='hl-teal'>שבר עשרוני</span> — שלוש דרכים לכתוב בדיוק אותו ערך:\n\n$37\\%=\\frac{37}{100}=0.37$\n\n<span class='hl-coral'>כדאי לדעת בעל-פה</span> את האחוזים ה\"ידידותיים\" הבאים, כי הם חוזרים על עצמם המון:\n- $50\\%=\\frac{1}{2}=0.5$ — חצי.\n- $25\\%=\\frac{1}{4}=0.25$ — רבע.\n- $75\\%=\\frac{3}{4}=0.75$ — שלושה רבעים.\n- $10\\%=\\frac{1}{10}=0.1$ — עשירית.\n\n<span class='hl-teal'>חישוב אחוז מכמות</span> — הכי קל להתחיל מ-$1\\%$: מחלקים את הכמות ב-$100$, ואז מכפילים באחוז המבוקש. לדוגמה, $30\\%$ מ-$200$: קודם $1\\%$ מ-$200$ הוא $200\\div100=2$, ואז $30\\%$ הוא $30\\times2=60$.\n\n<span class='hl-success'>קיצור שימושי</span>: $10\\%$ מכל מספר מתקבל פשוט על ידי הזזת הנקודה העשרונית מקום אחד שמאלה (או חילוק ב-$10$) — למשל $10\\%$ מ-$450$ הוא $45$. אפשר להשתמש בזה כדי לחשב גם $20\\%,30\\%,...$ (מכפילים את $10\\%$ במספר המתאים) או $5\\%$ (חצי מ-$10\\%$).\n\n<span class='hl-teal'>אחוזים בחיי היומיום</span> — מופיעים בדיאגרמת עוגה (כל פלח מייצג אחוז מהשלם, וסכום כל הפלחים הוא תמיד $100\\%$), בטבלאות סטטיסטיקה, ובעוד מקומות רבים.",
    "keyFormulas": [
      "אחוז: $x\\%=\\frac{x}{100}$",
      "$50\\%=\\frac{1}{2}$ | $25\\%=\\frac{1}{4}$ | $75\\%=\\frac{3}{4}$ | $10\\%=\\frac{1}{10}$",
      "אחוז מכמות: קודם מוצאים $1\\%$ (כמות $\\div100$), ואז מכפילים באחוז המבוקש",
      "כל פלחי דיאגרמת עוגה מסתכמים תמיד ל-$100\\%$"
    ]
  },
  {
    ...
    "cluster": "מספרים ופעולות",
    "title": "ספרות רומיות",
    "description": "סמלי הספרות הרומיות, כללי הצירוף (חיבור וחיסור), והמרה בין ספרות רומיות למספרים \"רגילים\"",
    "sortOrder": 21,
    "explanation": "בשיטה הרומית הישנה, כל מספר נכתב באמצעות <span class='hl-teal'>שבעה סמלים בלבד</span>, וכל סמל מייצג ערך קבוע:\n\n<div class='diagram-box'><svg viewBox='0 0 280 50' xmlns='http://www.w3.org/2000/svg'><g font-family='monospace' font-size='18' fill='#0d6e6e' text-anchor='middle'><text x='20' y='22'>I</text><text x='60' y='22'>V</text><text x='100' y='22'>X</text><text x='140' y='22'>L</text><text x='180' y='22'>C</text><text x='220' y='22'>D</text><text x='260' y='22'>M</text></g><g font-size='11' fill='#1a2b3c' text-anchor='middle'><text x='20' y='42'>1</text><text x='60' y='42'>5</text><text x='100' y='42'>10</text><text x='140' y='42'>50</text><text x='180' y='42'>100</text><text x='220' y='42'>500</text><text x='260' y='42'>1000</text></g></svg></div>\n\n<span class='hl-teal'>כלל החיבור</span> — כשסמל \"קטן\" נכתב <span class='hl-coral'>אחרי</span> סמל \"גדול\" ממנו (או שווה לו), מחברים את הערכים: $VII=5+1+1=7$, וכל סמל (חוץ מ-$I,X,C,M$) יכול להופיע לכל היותר $3$ פעמים ברצף: $III=3$, אבל אסור לכתוב $IIII$.\n\n<span class='hl-teal'>כלל החיסור</span> — כשסמל \"קטן\" נכתב <span class='hl-coral'>לפני</span> סמל \"גדול\" ממנו, מחסירים אותו: $IV=5-1=4$, $IX=10-1=9$. יש רק שישה צירופי חיסור מותרים: $IV(4),IX(9),XL(40),XC(90),CD(400),CM(900)$.\n\n<span class='hl-teal'>קריאת מספר רומי ארוך</span> — קוראים אותו \"בלוקים בלוקים\" משמאל לימין: אלפים, אז מאות, אז עשרות, אז יחידות. לדוגמה, $MCMXCIV$: $M(1000)+CM(900)+XC(90)+IV(4)=1994$.\n\n<span class='hl-teal'>כתיבת מספר \"רגיל\" בספרות רומיות</span> — פועלים בכיוון ההפוך: מפרקים את המספר לאלפים, מאות, עשרות ויחידות, וכותבים כל חלק בנפרד לפי הטבלה. לדוגמה, $48$: $40=XL$, $8=VIII$, ביחד $XLVIII$.\n\n<span class='hl-coral'>שימוש נפוץ</span> — ספרות רומיות עדיין מופיעות היום בשעונים, בכותרות פרקים בספרים, ובמספור מלכים ואפיפיורים (כמו לואי ה-$XIV$).",
    "keyFormulas": [
      "$I=1,V=5,X=10,L=50,C=100,D=500,M=1000$",
      "חיבור: סמל קטן אחרי סמל גדול — מחברים (עד $3$ סמלים זהים ברצף)",
      "חיסור: סמל קטן לפני סמל גדול — מחסירים ($IV,IX,XL,XC,CD,CM$ בלבד)",
  ...
  },
  {
    ...
    "keyFormulas": [
      ...
      "השיטה העשרונית: ערך ספרה נקבע לפי מיקומה, ב-$10$ סמלים בלבד",
      "בשיטה הרומית ובגימטריה אין ערך-מקום כמו בעשרונית"
    ]
  },
  {
    ...
    "keyFormulas": [
      ...
      "כפל בשבר קטן מ-$1$ מקטין; חילוק בשבר קטן מ-$1$ מגדיל",
      "מציאת השלם: מחלקים את הכמות הידועה בשבר שהיא מייצגת"
    ]
  },
  {
  ...
  },
  {
    ...
    "keyFormulas": [
      ...
      "שטח שווה לא אומר היקף שווה, ולהפך"
    ]
  },
  {
    "id": "g6-circle",
  ...
  },
  {
    ...
    "track": null,
    "cluster": "חקר נתונים",
    "title": "קריאה והצגה של נתונים",
    "description": "קריאת נתונים מטבלאות, דיאגרמות שונות ופיקטוגרמות, והצגת נתונים בדרכים שונות",
    "sortOrder": 9,
    "explanation": "נתונים אפשר להציג בכמה דרכים, ולכל אחת יש יתרונות וחסרונות:\n\n<span class='hl-teal'>טבלת שכיחויות</span> — מדויקת, קל לקרוא ערך ספציפי, אבל קשה לראות מגמות במבט חטוף.\n\n<span class='hl-teal'>דיאגרמת עמודות</span> — מצוינת להשוואה מהירה בין קטגוריות שונות.\n\n<span class='hl-teal'>דיאגרמת עוגה</span> — מראה חלוקה יחסית של שלם; טובה כדי לראות איזה חלק כל קטגוריה תופסת מתוך הכול.\n\n<span class='hl-teal'>פיקטוגרם</span> — משתמש בסמלים חוזרים כדי לייצג כמויות, קריא וידידותי אך פחות מדויק (במיוחד עם חצאי סמלים).\n\n<div class='diagram-box'><svg viewBox='0 0 260 110' xmlns='http://www.w3.org/2000/svg'><line x1='20' y1='90' x2='120' y2='90' stroke='#1a2b3c' stroke-width='2'/><line x1='20' y1='90' x2='20' y2='10' stroke='#1a2b3c' stroke-width='2'/><rect x='35' y='55' width='22' height='35' fill='#0d6e6e' opacity='0.6'/><rect x='65' y='30' width='22' height='60' fill='#0d6e6e' opacity='0.6'/><rect x='95' y='65' width='22' height='25' fill='#0d6e6e' opacity='0.6'/><circle cx='195' cy='50' r='40' fill='none' stroke='#0d6e6e' stroke-width='2'/><path d='M195,50 L195,10 A40,40 0 0 1 230,70 Z' fill='#c45c48' opacity='0.4'/></svg></div>\n\n<span class='hl-coral'>אותו מידע, כמה ייצוגים</span> — חשוב לדעת לעבור בין ייצוגים שונים (מטבלה לעמודות, מעוגה לטבלה וכו') ולזהות שכולם מציגים בדיוק את אותו מידע, רק בצורה שונה. חשוב גם לדעת להשלים נתונים חסרים בייצוג אחד לפי מידע שמופיע בייצוג אחר.",
    "keyFormulas": [
      "טבלה: מדויקת אך פחות ויזואלית",
      "דיאגרמת עמודות: טובה להשוואה בין קטגוריות",
      "דיאגרמת עוגה: מציגה חלוקה יחסית של שלם",
      "פיקטוגרם: סמלים חוזרים, שימו לב לחצאי סמלים"
    ]
  },
  {
    "id": "g6-data-prob",
  ...
  },
  {
    ...
    "track": null,
    "cluster": "מספרים ופעולות",
    "title": "מספרים מכוונים — היכרות",
    "description": "מספרים חיוביים ושליליים בהקשרי חיים, ציר המספרים, מספר נגדי וערך מוחלט",
    "sortOrder": 12,
    "explanation": "<span class='hl-teal'>מספרים מכוונים</span> הם מספרים עם <span class='hl-teal'>כיוון</span> — חיוביים או שליליים — שמתארים מצבים \"משני צדי\" נקודת התייחסות מוסכמת (בדרך כלל $0$).\n\n<span class='hl-teal'>דוגמאות מחיי היומיום</span>:\n- <span class='hl-teal'>טמפרטורה</span>: $5°$ מעל האפס לעומת $5°$ מתחת לאפס ($-5°$).\n- <span class='hl-teal'>גובה</span>: $200$ מטר מעל פני הים לעומת $200$ מטר מתחת לפני הים (כמו ים המלח).\n- <span class='hl-teal'>כסף</span>: יתרת זכות בבנק (חיובי) לעומת חוב (שלילי).\n- <span class='hl-teal'>קומות</span>: קומה $2$ לעומת קומת חניון $-2$ (מתחת לקרקע).\n\n<div class='diagram-box'><svg viewBox='0 0 260 50' xmlns='http://www.w3.org/2000/svg'><line x1='10' y1='25' x2='250' y2='25' stroke='#1a2b3c' stroke-width='2'/><g font-family='monospace' font-size='13' fill='#1a2b3c' text-anchor='middle'><text x='30' y='15'>-5</text><text x='90' y='15'>-2</text><text x='130' y='15'>0</text><text x='170' y='15'>2</text><text x='230' y='15'>5</text></g><circle cx='130' cy='25' r='3' fill='#c45c48'/></svg></div>\n\nעל <span class='hl-teal'>ציר המספרים</span>, המספרים השליליים נמצאים <span class='hl-coral'>משמאל</span> לאפס, והחיוביים מימין. <span class='hl-success'>ככל שנעים ימינה, המספר גדול יותר</span> — לכן $-3>-7$ (למרות ש-$7>3$!), כי $-3$ קרוב יותר ל-$0$ מאשר $-7$.\n\n<span class='hl-teal'>מספר נגדי</span> — לכל מספר יש \"תאום\" בצד השני של $0$, באותו מרחק בדיוק. הנגדי של $5$ הוא $-5$, והנגדי של $-5$ הוא $5$.\n\n<span class='hl-teal'>ערך מוחלט</span> ($|a|$) — המרחק של המספר $a$ מ-$0$ על הציר, <span class='hl-coral'>בלי קשר לכיוון</span> — ולכן הוא תמיד אי-שלילי: $|5|=5$ וגם $|-5|=5$ (שני המספרים באותו מרחק מ-$0$, רק בכיוונים מנוגדים).",
    "keyFormulas": [
      "מספר שלילי מתאר כיוון הפוך ממספר חיובי (מתחת לאפס, מתחת לפני הים, חוב וכו')",
      "בציר המספרים: ככל שנעים ימינה, המספר גדול יותר — $-3>-7$",
      "הנגדי של $a$ הוא $-a$: אותו מרחק מ-$0$, בכיוון הפוך",
      "ערך מוחלט $|a|$ = המרחק של $a$ מ-$0$ (תמיד אי-שלילי): $|-5|=|5|=5$"
    ]
  },
  {
    ...
    "track": null,
    "cluster": "מספרים ופעולות",
    "title": "מערכות מספרים — בסיסים שונים",
    "description": "מבנה עשרוני (בסיס 10) לעומת בסיסים אחרים, והיכרות עם השיטה הבינארית",
    "sortOrder": 13,
    "explanation": "השיטה שבה אנחנו כותבים מספרים נקראת <span class='hl-teal'>בסיס $10$</span> (עשרונית): יש בה בדיוק $10$ ספרות שונות ($0$ עד $9$), וכל <span class='hl-teal'>מקום</span> במספר שווה <span class='hl-teal'>פי $10$</span> מהמקום שמימינו (יחידות, עשרות, מאות...).\n\nאפשר לבנות שיטות דומות עם <span class='hl-coral'>בסיס אחר</span>. ב<span class='hl-teal'>בסיס $5$</span>, למשל, יש רק $5$ ספרות ($0,1,2,3,4$), וכל מקום שווה פי $5$ מהמקום שמימינו (יחידות, חמישיות, עשרים-וחמישיות...). המספר $23_5$ (נקרא \"$2,3$ בבסיס $5$\") שווה $2\\times5+3=13$ בעשרוני.\n\n<span class='hl-teal'>הבסיס החשוב ביותר במחשבים הוא בסיס $2$</span> — <span class='hl-teal'>השיטה הבינארית</span>. בבינארי יש רק שתי ספרות: $0$ ו-$1$, וכל מקום שווה פי $2$ מהמקום שמימינו: יחידות ($1$), שתיים ($2$), ארבעות ($4$), שמונות ($8$), וכן הלאה.\n\n<div class='diagram-box'><svg viewBox='0 0 260 60' xmlns='http://www.w3.org/2000/svg'><g font-family='monospace' font-size='16' fill='#0d6e6e' text-anchor='middle'><text x='40' y='25'>1</text><text x='90' y='25'>0</text><text x='140' y='25'>1</text><text x='190' y='25'>1</text></g><g font-size='10' fill='#1a2b3c' text-anchor='middle'><text x='40' y='45'>8</text><text x='90' y='45'>4</text><text x='140' y='45'>2</text><text x='190' y='45'>1</text></g><text x='230' y='30' font-size='13' fill='#c45c48'>=11</text></svg></div>\n\nלדוגמה, $1011_2=1\\times8+0\\times4+1\\times2+1\\times1=8+0+2+1=11$ בעשרוני.\n\n<span class='hl-coral'>הרעיון המשותף לכל הבסיסים</span>: ערך הספרה תלוי הן בספרה עצמה והן <span class='hl-teal'>במיקומה</span> — זו \"שיטת ערך-מקום\", בניגוד לשיטה הרומית, שבה לכל סמל יש ערך קבוע בלי קשר למיקום.",
    "keyFormulas": [
      "בבסיס $10$: כל מקום שווה פי $10$ מהמקום שמימינו",
      "בבסיס $b$ כלשהו יש $b$ ספרות ($0$ עד $b-1$), וכל מקום שווה פי $b$ מהמקום שמימינו",
      "בבסיס $2$ (בינארי) יש רק $0,1$; המקומות הם $1,2,4,8,16...$",
      "$1011_2=1\\times8+0\\times4+1\\times2+1\\times1=11$ בעשרוני"
    ]
  },
  {
    ...
    "track": null,
    "cluster": "מספרים ופעולות",
    "title": "שברים ועשרוניים על ישר המספרים וצפיפות",
    "description": "מיקום מדויק של שברים ושברים עשרוניים על הציר, השוואה גרפית, וצפיפות המספרים הרציונליים",
    "sortOrder": 14,
    "explanation": "כדי למקם שבר על ציר המספרים <span class='hl-teal'>בדיוק</span>, מחלקים כל קטע שלם למספר חלקים שווים כמו <span class='hl-teal'>המכנה</span> של השבר. למשל, כדי לסמן $\\frac{3}{8}$, מחלקים את הקטע בין $0$ ל-$1$ ל-$8$ חלקים שווים, וסופרים $3$ מהם.\n\n<div class='diagram-box'><svg viewBox='0 0 260 50' xmlns='http://www.w3.org/2000/svg'><line x1='20' y1='25' x2='240' y2='25' stroke='#1a2b3c' stroke-width='2'/><g stroke='#1a2b3c' stroke-width='1'><line x1='20' y1='20' x2='20' y2='30'/><line x1='47.5' y1='20' x2='47.5' y2='30'/><line x1='75' y1='20' x2='75' y2='30'/><line x1='102.5' y1='20' x2='102.5' y2='30'/><line x1='130' y1='22' x2='130' y2='32'/><line x1='157.5' y1='20' x2='157.5' y2='30'/><line x1='185' y1='20' x2='185' y2='30'/><line x1='212.5' y1='20' x2='212.5' y2='30'/><line x1='240' y1='20' x2='240' y2='30'/></g><circle cx='102.5' cy='25' r='3' fill='#c45c48'/><text x='20' y='45' font-size='11' text-anchor='middle'>0</text><text x='240' y='45' font-size='11' text-anchor='middle'>1</text><text x='102.5' y='12' font-size='11' fill='#c45c48' text-anchor='middle'>3/8</text></svg></div>\n\n<span class='hl-teal'>שברים עשרוניים</span> ממוקמים באותו עיקרון — לדוגמה, $0.6$ נמצא $6$ חלקים מתוך $10$ בקטע שבין $0$ ל-$1$.\n\n<span class='hl-teal'>השוואה גרפית</span> — כשמסמנים שני מספרים על אותו ציר, המספר <span class='hl-coral'>שמימין</span> תמיד גדול יותר. זו דרך נוחה להשוות בין שברים, שברים עשרוניים, ואפילו מספרים מטיפוסים שונים (למשל $\\frac{3}{4}$ מול $0.7$).\n\n<span class='hl-coral'>צפיפות המספרים</span> — בניגוד למספרים הטבעיים (שבהם יש \"עוקב\" ברור, למשל אחרי $3$ בא $4$), בין <span class='hl-teal'>כל שני מספרים רציונליים שונים</span> (שברים או שברים עשרוניים) <span class='hl-teal'>אפשר תמיד למצוא עוד מספר</span> — ולמעשה, <span class='hl-coral'>אינסוף מספרים</span>. לדוגמה, בין $0.2$ ל-$0.3$ אפשר למצוא את $0.25$; בין $0.2$ ל-$0.25$ אפשר למצוא את $0.22$; וכן הלאה, בלי סוף.",
    "keyFormulas": [
      "כדי למקם שבר על הציר, מחלקים כל קטע שלם למספר חלקים שווה למכנה",
      "מספר גדול יותר תמיד נמצא מימין למספר קטן יותר על הציר",
      "צפיפות: בין כל שני מספרים רציונליים שונים תמיד יש עוד מספר רציונלי (ולמעשה, אינסוף)",
      "לדוגמה: בין $0.2$ ל-$0.3$ נמצא $0.25$; ובין $0.2$ ל-$0.25$ נמצא $0.22$"
    ]
  },
  {
    "id": "g6-ratio",
    ...
    "units": null,
    "track": null,
    "cluster": "יחס, קנה מידה ותנועה",
    "title": "יחס",
    "description": "יצירת כמויות לפי יחס נתון, צמצום יחס, מציאת מספר חסר, וחלוקת כמות לפי יחס",
    "sortOrder": 15,
    "explanation": "<span class='hl-teal'>יחס</span> הוא דרך להשוות בין שתי כמויות (או יותר), וכותבים אותו עם נקודתיים: $a:b$. לדוגמה, אם בכיתה יש $12$ בנות ו-$8$ בנים, היחס בין בנות לבנים הוא $12:8$.\n\n<span class='hl-teal'>צמצום יחס</span> — בדיוק כמו צמצום שבר: מחלקים את שני האגפים באותו מספר (המחלק המשותף הגדול ביותר) כדי לקבל יחס שווה-ערך פשוט יותר: $12:8=3:2$ (מחלקים ב-$4$).\n\n<span class='hl-teal'>יחסים שווים</span> — שני יחסים שווים אם השברים המתאימים להם שווים: $a:b=c:d$ כאשר $\\frac{a}{b}=\\frac{c}{d}$. לדוגמה $2:3=8:12$, כי $\\frac{2}{3}=\\frac{8}{12}$.\n\n<span class='hl-teal'>מציאת מספר חסר ביחס</span> — מוצאים את <span class='hl-coral'>מקדם ההגדלה</span> בין שני האגפים המוכרים, ומפעילים אותו גם על האגף השני. לדוגמה, $2:3=8:x$: מ-$2$ ל-$8$ הכפילו פי $4$ ($2\\times4=8$), אז גם $3$ צריך להיות מוכפל פי $4$: $x=3\\times4=12$.\n\n<span class='hl-teal'>חלוקת כמות לפי יחס נתון</span> — למשל, לחלק $40$ סוכריות בין שני ילדים ביחס $3:5$:\n1. סוכמים את חלקי היחס: $3+5=8$ \"חלקים\".\n2. מוצאים כמה שווה חלק אחד: $40\\div8=5$.\n3. מכפילים כל צד במספר החלקים שלו: $3\\times5=15$ ו-$5\\times5=25$ (בדיקה: $15+25=40$ ✓).",
    "keyFormulas": [
      "יחס $a:b$ משווה בין שתי כמויות; אפשר לצמצם כמו שבר: $12:8=3:2$",
      "יחסים שווים: $a:b=c:d$ כאשר $\\frac{a}{b}=\\frac{c}{d}$",
      "מציאת מספר חסר: מוצאים את מקדם ההגדלה בין הזוג הידוע ומפעילים אותו על השני",
      "חלוקה לפי יחס $a:b$: מחלקים ב-$(a+b)$ \"חלקים\", וכל צד מקבל את חלקו"
    ]
  },
  {
    "id": "g6-scale",
    ...
    "cluster": "יחס, קנה מידה ותנועה",
    "title": "קנה מידה",
    "description": "יחס בין מרחק בשרטוט/במפה למרחק במציאות, חישוב עם קני מידה, והשפעת קנה מידה על שטח",
    "sortOrder": 16,
    "explanation": "<span class='hl-teal'>קנה מידה</span> הוא יחס מיוחד שמשווה בין מרחק <span class='hl-teal'>בשרטוט או במפה</span> לבין המרחק המתאים <span class='hl-teal'>במציאות</span>. כותבים אותו כ-$1:N$, כלומר: כל יחידת אורך אחת בשרטוט מייצגת $N$ יחידות במציאות.\n\nלדוגמה, קנה מידה $1:100{,}000$ אומר שכל ס\"מ במפה מייצג $100{,}000$ ס\"מ במציאות — כלומר $1$ ק\"מ.\n\n<span class='hl-teal'>מרחק במציאות $=$ מרחק בשרטוט $\\times N$</span>. לדוגמה, אם על מפה בקנה מידה $1:50{,}000$ המרחק בין שני יישובים הוא $4$ ס\"מ, המרחק האמיתי הוא $4\\times50{,}000=200{,}000$ ס\"מ $=2$ ק\"מ.\n\n<span class='hl-coral'>הכיוון ההפוך</span>: <span class='hl-teal'>מרחק בשרטוט $=$ מרחק במציאות $\\div N$</span> — משתמשים בזה כדי לצייר תוכנית מוקטנת (כמו תוכנית בית) של דבר גדול במציאות.\n\n<span class='hl-coral'>שימו לב לתכונה חשובה</span>: קנה מידה $1:N$ משפיע רק על <span class='hl-teal'>אורכים</span> — אבל <span class='hl-teal'>שטחים</span> מתכווצים או גדלים <span class='hl-coral'>פי $N^2$</span>, לא פי $N$! מכיוון ששטח נמדד בשתי מידות (אורך ורוחב) בו-זמנית, כל אחת מהן מוכפלת ב-$N$, ולכן השטח מוכפל ב-$N\\times N=N^2$. לדוגמה, בקנה מידה $1:10$, שטח בשרטוט קטן פי $10^2=100$ משטח המציאות.",
    "keyFormulas": [
      "קנה מידה $1:N$ — כל יחידה בשרטוט מייצגת $N$ יחידות במציאות",
      "מרחק במציאות $=$ מרחק בשרטוט $\\times N$",
      "מרחק בשרטוט $=$ מרחק במציאות $\\div N$",
      "בקנה מידה $1:N$, שטחים משתנים פי $N^2$ (לא פי $N$)!"
    ]
  },
  {
    "id": "g6-motion-rate",
    ...
    "track": null,
    "cluster": "יחס, קנה מידה ותנועה",
    "title": "בעיות תנועה והספק",
    "description": "מהירות כיחס בין מרחק לזמן, נוסחת מהירות-מרחק-זמן, ובעיות הספק (קצב עבודה)",
    "sortOrder": 17,
    "explanation": "<span class='hl-teal'>מהירות</span> מתארת כמה מרחק עוברים ב<span class='hl-teal'>יחידת זמן אחת</span> — היא בעצם <span class='hl-teal'>יחס</span> בין מרחק לזמן. לדוגמה, מכונית שעברה $180$ ק\"מ ב-$3$ שעות נסעה במהירות ממוצעת של $180\\div3=60$ קמ\"ש (קילומטר לשעה).\n\n<div class='diagram-box'><svg viewBox='0 0 200 90' xmlns='http://www.w3.org/2000/svg'><polygon points='100,15 30,80 170,80' fill='none' stroke='#0d6e6e' stroke-width='2'/><line x1='30' y1='47' x2='170' y2='47' stroke='#0d6e6e' stroke-width='1.5' stroke-dasharray='3'/><text x='100' y='35' text-anchor='middle' font-size='13' fill='#c45c48'>מרחק</text><text x='58' y='68' text-anchor='middle' font-size='13' fill='#1a2b3c'>מהירות</text><text x='142' y='68' text-anchor='middle' font-size='13' fill='#1a2b3c'>זמן</text></svg></div>\n\n<span class='hl-teal'>שלוש הנוסחאות הקשורות</span> (אפשר לגזור כל אחת מהאחרות):\n- מהירות $=$ מרחק $\\div$ זמן.\n- מרחק $=$ מהירות $\\times$ זמן.\n- זמן $=$ מרחק $\\div$ מהירות.\n\n<span class='hl-teal'>בעיות הספק</span> (קצב עבודה) עובדות <span class='hl-teal'>בדיוק לפי אותו עיקרון</span>, רק שבמקום \"מרחק\" יש \"כמות עבודה\" (למשל, כמה מוצרים מייצרת מכונה, או כמה עמודים כותב מישהו): הספק $=$ כמות עבודה $\\div$ זמן. לדוגמה, מכונה שמייצרת $150$ בקבוקים ב-$5$ דקות עובדת בהספק של $150\\div5=30$ בקבוקים לדקה.\n\n<span class='hl-coral'>שימו לב</span> — בבעיות עם כמה גופים נעים (אחד לקראת השני, או אחד רודף אחרי השני), חשוב תמיד לזהות בבירור מה ידוע (מרחק כולל, מהירויות, זמן יציאה) ומה מבקשים למצוא, ולכתוב משוואה מתאימה לכל מקרה.",
    "keyFormulas": [
      "מהירות $=$ מרחק $\\div$ זמן",
      "מרחק $=$ מהירות $\\times$ זמן",
      "זמן $=$ מרחק $\\div$ מהירות",
      "הספק (קצב עבודה) $=$ כמות עבודה $\\div$ זמן — אותו עיקרון כמו מהירות"
    ]
  },
  {
    ...
    "cluster": "גאומטריה ומדידות",
    "title": "פירמידה — נפח",
    "description": "נפח פירמידה כשליש מנפח מנסרה מתאימה, ותרגול עם בסיסים שונים",
    "sortOrder": 18,
    "explanation": "<span class='hl-teal'>נפח פירמידה</span> קשור בצורה יפה לנפח מנסרה: אם לוקחים פירמידה ומנסרה בעלות <span class='hl-teal'>אותו בסיס ואותו גובה</span>, נפח הפירמידה הוא <span class='hl-coral'>בדיוק שליש</span> מנפח המנסרה. אפשר להדגים זאת בפועל: <span class='hl-teal'>שלוש פירמידות זהות</span> (אותו בסיס וגובה) ממלאות בדיוק מנסרה אחת שלמה!\n\n<div class='diagram-box'><svg viewBox='0 0 220 100' xmlns='http://www.w3.org/2000/svg'><polygon points='50,90 90,90 70,75 30,75' fill='none' stroke='#0d6e6e' stroke-width='2'/><line x1='30' y1='75' x2='60' y2='15' stroke='#0d6e6e' stroke-width='2'/><line x1='90' y1='90' x2='60' y2='15' stroke='#0d6e6e' stroke-width='2'/><line x1='70' y1='75' x2='60' y2='15' stroke='#0d6e6e' stroke-width='2' stroke-dasharray='3'/><line x1='50' y1='90' x2='60' y2='15' stroke='#0d6e6e' stroke-width='2'/><text x='60' y='10' text-anchor='middle' font-size='11' fill='#1a2b3c'>גובה</text><text x='160' y='50' text-anchor='middle' font-size='30' fill='#c45c48'>×3</text></svg></div>\n\nלכן <span class='hl-teal'>נוסחת נפח הפירמידה</span> היא בדיוק שליש מנוסחת נפח המנסרה (שטח בסיס $\\times$ גובה):\n\n$$\\text{נפח פירמידה}=\\frac{1}{3}\\times\\text{שטח הבסיס}\\times\\text{גובה}$$\n\nהנוסחה עובדת <span class='hl-teal'>בדיוק אותו הדבר</span> לא משנה איזו צורה הבסיס — ריבוע, מלבן, משולש, או כל מצולע אחר — כל עוד יודעים לחשב את שטח הבסיס.\n\n<span class='hl-teal'>דוגמה</span>: פירמידה עם בסיס מלבני $6\\times4$ ס\"מ וגובה $9$ ס\"מ: שטח הבסיס $=6\\times4=24$ סמ\"ר, ונפח הפירמידה $=\\frac{1}{3}\\times24\\times9=\\frac{216}{3}=72$ סמ\"ק.\n\n<span class='hl-coral'>שימו לב</span> — הגובה של הפירמידה הוא המרחק המאונך מהפסגה אל מישור הבסיס, לא אורך אחת הצלעות המשופעות.",
    "keyFormulas": [
      "נפח פירמידה $=\\frac{1}{3}\\times$ שטח הבסיס $\\times$ גובה",
      "$3$ פירמידות זהות (אותו בסיס וגובה) ממלאות בדיוק מנסרה אחת",
      "עובד עם כל צורת בסיס — ריבוע, מלבן, משולש ועוד",
      "דוגמה: בסיס $6\\times4$, גובה $9$: נפח $=\\frac{1}{3}\\times24\\times9=72$"
    ]
  },
  {
    "id": "g6-cylinder",
    ...
    "track": null,
    "cluster": "גאומטריה ומדידות",
    "title": "גליל — נפח ושטח פנים",
    "description": "מבנה הגליל (שני בסיסים עגולים ומעטפת), נפח הגליל ושטח הפנים שלו",
    "sortOrder": 19,
    "explanation": "<span class='hl-teal'>גליל</span> בנוי משני <span class='hl-teal'>בסיסים עגולים זהים ומקבילים</span>, מחוברים ב<span class='hl-teal'>מעטפת</span> מעוגלת. אם \"פורסים\" את הגליל (חותכים לאורך ופותחים), מתקבלים: שני עיגולים (הבסיסים), ו<span class='hl-coral'>מלבן</span> אחד (המעטפת שנפרסה).\n\n<div class='diagram-box'><svg viewBox='0 0 220 100' xmlns='http://www.w3.org/2000/svg'><ellipse cx='60' cy='25' rx='35' ry='12' fill='none' stroke='#0d6e6e' stroke-width='2'/><line x1='25' y1='25' x2='25' y2='75' stroke='#0d6e6e' stroke-width='2'/><line x1='95' y1='25' x2='95' y2='75' stroke='#0d6e6e' stroke-width='2'/><ellipse cx='60' cy='75' rx='35' ry='12' fill='none' stroke='#0d6e6e' stroke-width='2'/><rect x='140' y='25' width='60' height='50' fill='none' stroke='#c45c48' stroke-width='2'/><text x='170' y='20' text-anchor='middle' font-size='10' fill='#c45c48'>2πr</text></svg></div>\n\n<span class='hl-teal'>נפח הגליל</span> מחושב בדיוק כמו כל מנסרה — <span class='hl-teal'>שטח הבסיס כפול הגובה</span>. מכיוון שהבסיס הוא עיגול, שטחו $\\pi r^2$:\n\n$$\\text{נפח גליל}=\\pi r^2\\times h$$\n\n<span class='hl-teal'>שטח הפנים</span> מורכב משלושה חלקים: שני העיגולים (הבסיסים), ומעטפת המלבן. <span class='hl-coral'>רוחב המלבן</span> שווה בדיוק ל<span class='hl-teal'>היקף הבסיס העגול</span> ($2\\pi r$), וגובהו הוא גובה הגליל ($h$):\n\n$$\\text{שטח פנים}=2\\pi r^2+2\\pi rh$$\n\n<span class='hl-teal'>דוגמה</span>: גליל שרדיוס בסיסו $3$ ס\"מ וגובהו $10$ ס\"מ (עם $\\pi\\approx3.14$): נפח $\\approx3.14\\times9\\times10=282.6$ סמ\"ק.",
    "keyFormulas": [
      "נפח גליל $=\\pi r^2\\times h$ (שטח הבסיס $\\times$ גובה)",
      "שטח פני הגליל $=2\\pi r^2+2\\pi rh$",
      "המעטפת הפרושה היא מלבן: רוחבו $2\\pi r$ (היקף הבסיס), גובהו $h$",
      "$\\pi\\approx3.14$"
    ]
  },
  {
    ...
    "track": null,
    "cluster": "גאומטריה ומדידות",
    "title": "חרוט וכדור — נפח",
    "description": "נפח חרוט כשליש מנפח גליל מתאים, ונפח כדור לפי הנוסחה",
    "sortOrder": 20,
    "explanation": "<span class='hl-teal'>חרוט</span> הוא כמו \"פירמידה עגולה\" — יש לו בסיס עגול אחד ופסגה חדה. בדיוק כמו שפירמידה קשורה למנסרה, <span class='hl-teal'>חרוט קשור לגליל</span> בעל אותו בסיס וגובה: נפח החרוט הוא <span class='hl-coral'>בדיוק שליש</span> מנפח הגליל המתאים.\n\n<div class='diagram-box'><svg viewBox='0 0 220 100' xmlns='http://www.w3.org/2000/svg'><ellipse cx='60' cy='80' rx='40' ry='13' fill='none' stroke='#0d6e6e' stroke-width='2'/><line x1='20' y1='80' x2='60' y2='10' stroke='#0d6e6e' stroke-width='2'/><line x1='100' y1='80' x2='60' y2='10' stroke='#0d6e6e' stroke-width='2'/><circle cx='170' cy='50' r='30' fill='none' stroke='#c45c48' stroke-width='2'/><text x='60' y='98' text-anchor='middle' font-size='10' fill='#1a2b3c'>חרוט</text><text x='170' y='90' text-anchor='middle' font-size='10' fill='#1a2b3c'>כדור</text></svg></div>\n\n$$\\text{נפח חרוט}=\\frac{1}{3}\\times\\pi r^2\\times h=\\frac{1}{3}\\pi r^2h$$\n\nלדוגמה, חרוט עם רדיוס בסיס $6$ ס\"מ וגובה $5$ ס\"מ: נפח $=\\frac{1}{3}\\times3.14\\times36\\times5\\approx188.4$ סמ\"ק.\n\n<span class='hl-teal'>כדור</span> הוא צורה תלת-ממדית שכל נקודה על פניה נמצאת <span class='hl-teal'>באותו מרחק בדיוק</span> ממרכז אחד (בדיוק כמו מעגל, אבל במרחב). נפח הכדור מחושב לפי נוסחה קבועה:\n\n$$\\text{נפח כדור}=\\frac{4}{3}\\times\\pi r^3$$\n\nלדוגמה, כדור שרדיוסו $3$ ס\"מ: נפח $=\\frac{4}{3}\\times3.14\\times27\\approx113.04$ סמ\"ק.\n\n<span class='hl-coral'>שימו לב</span> — $r^3$ ($r$ בחזקת $3$) פירושו $r\\times r\\times r$, ולא $r\\times3$!",
    "keyFormulas": [
      "נפח חרוט $=\\frac{1}{3}\\pi r^2h$ (שליש מנפח הגליל המתאים)",
      "נפח כדור $=\\frac{4}{3}\\pi r^3$",
      "$r^3=r\\times r\\times r$ (לא $r\\times3$!)",
      "$\\pi\\approx3.14$"
    ]
  },
  {
    ...
    "description": "חמשת הגופים המשוכללים (האפלטוניים) ותכונותיהם: פאות, קודקודים ומקצועות זהים",
    "sortOrder": 21,
    "explanation": "<span class='hl-teal'>גוף משוכלל</span> (\"אפלטוני\") הוא גוף תלת-ממדי שבו <span class='hl-teal'>כל הפאות הן מצולעים משוכללים זהים</span>, וגם <span class='hl-teal'>אותו מספר פאות נפגש בכל קודקוד</span>. יש בדיוק <span class='hl-coral'>$5$ גופים כאלה</span>, לא יותר ולא פחות:\n\n<div class='diagram-box'><svg viewBox='0 0 280 70' xmlns='http://www.w3.org/2000/svg'><g font-family='monospace' font-size='10' fill='#1a2b3c' text-anchor='middle'><text x='28' y='15'>טטרהדרון</text><text x='84' y='15'>קובייה</text><text x='140' y='15'>אוקטהדרון</text><text x='196' y='15'>דודקהדרון</text><text x='252' y='15'>איקוסהדרון</text></g><g font-size='9' fill='#0d6e6e' text-anchor='middle'><text x='28' y='60'>4 משולשים</text><text x='84' y='60'>6 ריבועים</text><text x='140' y='60'>8 משולשים</text><text x='196' y='60'>12 מחומשים</text><text x='252' y='60'>20 משולשים</text></g></svg></div>\n\n- <span class='hl-teal'>טטרהדרון</span> (פירמידה משולשת) — $4$ פאות משולשות.\n- <span class='hl-teal'>קובייה (הקסהדרון)</span> — $6$ פאות מרובעות.\n- <span class='hl-teal'>אוקטהדרון</span> — $8$ פאות משולשות.\n- <span class='hl-teal'>דודקהדרון</span> — $12$ פאות מחומשות.\n- <span class='hl-teal'>איקוסהדרון</span> — $20$ פאות משולשות.\n\n<span class='hl-coral'>עובדה מעניינת</span>: בכל אחד מהגופים המשוכללים (וגם בהרבה גופים קמורים אחרים!) מתקיים קשר קבוע בין מספר הקודקודים ($V$), המקצועות ($E$) והפאות ($F$), שנקרא <span class='hl-teal'>נוסחת אוילר</span>:\n\n$$V-E+F=2$$\n\nלדוגמה, בקובייה: $8$ קודקודים, $12$ מקצועות, $6$ פאות: $8-12+6=2$ ✓.",
    "keyFormulas": [
      "יש בדיוק $5$ גופים משוכללים: טטרהדרון, קובייה, אוקטהדרון, דודקהדרון, איקוסהדרון",
      "בגוף משוכלל: כל הפאות הן מצולעים משוכללים זהים, וכל הקודקודים דומים זה לזה",
      "נוסחת אוילר: קודקודים $-$ מקצועות $+$ פאות $=2$",
      "קובייה: $8-12+6=2$ ✓"
    ]
  }
];
